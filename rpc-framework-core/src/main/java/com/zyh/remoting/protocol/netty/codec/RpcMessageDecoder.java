...
public class RpcMessageDecoder extends LengthFieldBasedFrameDecoder {
    ...
    /**
     * @param maxFrameLength      Maximum frame length. It decide the maximum length of data that can be received. If it
     *                            exceeds, the data will be discarded.
     * @param lengthFieldOffset   Length field offset. The length field is the one that skips the specified length of
     *                            byte.
     * @param lengthFieldLength   The number of bytes in the length field.
     * @param lengthAdjustment    The compensation value to add to the value of the length field
     * @param initialBytesToStrip Number of bytes skipped. If you need to receive all of the header+body data, this
     *                            value is 0 if you only want to receive the body data, then you need to skip the number
     *                            of bytes consumed by the header.
     */
